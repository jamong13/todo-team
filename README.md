...
사용자의 위치·날씨·날짜·취향 등을 기반으로 할 일 / 옷차림 / 영화 / 맛집을 한 화면에서 확인하고 추천받을 수 있습니다.
...
사용자의 실시간 위치 기반 날씨 수집

현재 온도, 습도, 자외선 지수, 대기 질 등을 분석해
...
카테고리(한식/양식/일식/카페 등) 필터링 지원

상세 정보(주소/거리/평점 등) 표시

🖼️ 메인 화면

메인 페이지에서는 아래 4개의 섹션 정보를 한눈에 확인할 수 있습니다:
...
각 섹션을 클릭하면 해당 기능의 상세 페이지로 이동합니다.
